...
const MONGO_URL="mongodb+srv://Balarathinam:Bala4321@cluster0.31zguzs.mongodb.net";
...
// tasks1
//it's LOBO time babay🤩
app.get("/movies/:id", async function (request, response) {
  const {id}=request.params;
    console.log(request.params,id);
    // const movies=Movie.find((mv)=>mv.id==id); 
  const movies=await client.db('b40wd').collection("movies").findOne({id: id});
